...
(define_expand "gen_mask1"
  ...
  ""
  {
    ...
    {
      case 0x01:
        emit (gen_mask1_0x01 (operands[0], operands[2]));
        break;
      case 0x80:
        emit (gen_mask1_0x80 (operands[0], operands[2]));
        break;
      case 0xfe:
        emit (gen_mask1_0xfe (operands[0], operands[2]));
        break;
      case 0x7f:
...
(define_insn_and_split "*popcounthi2.split8"
  [(set (reg:HI 24)
        (popcount:HI (match_operand:QI 0 "register_operand")))]
  "! reload_completed"
  { gcc_unreachable(); }
  "&& 1"
  [(set (reg:QI 24)
